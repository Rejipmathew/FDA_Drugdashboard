...
# Streamlit App Title
st.title("FDA Drug Label Fetcher")
...
manufacturer_name = st.sidebar.text_input("Manufacturer Name (first 5 characters)")
...
if start_date > end_date:
    ...
    if manufacturer_name:
        # Only take the first four characters and add the wildcard
        manufacturer_search = manufacturer_name[:5] + "*"
